module Gem
  ...
  ConfigMap = {:EXEEXT=>"", :RUBY_SO_NAME=>"ruby", :arch=>"x86_64-linux", :bindir=>"/usr/local/rvm/rubies/ruby-1.9.2-p318/bin", :libdir=>"/usr/local/rvm/rubies/ruby-1.9.2-p318/lib", :ruby_install_name=>"ruby", :ruby_version=>"1.9.1", :rubylibprefix=>"/usr/local/rvm/rubies/ruby-1.9.2-p318/lib/ruby", :sitedir=>"/usr/local/rvm/rubies/ruby-1.9.2-p318/lib/ruby/site_ruby", :sitelibdir=>"/usr/local/rvm/rubies/ruby-1.9.2-p318/lib/ruby/site_ruby/1.9.1"}
